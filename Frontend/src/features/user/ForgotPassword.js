              ...
              <>
                ...
                <form onSubmit={submitEmailForm}>
                  ...
                  <button
                    type="submit"
                    className={
                      "btn mt-2 w-full bg-gradient-to-r from-green-500 to-lime-500 text-white transition duration-300 ease-in-out transform hover:scale-105"
                    }
                  >
