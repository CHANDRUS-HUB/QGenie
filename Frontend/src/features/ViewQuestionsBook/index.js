...
const Generated_Questions = () => {
  ...
  return (
    <div className="p-6  dark:text-gray-100 min-h-screen">
      <Toaster />
      {/* Back Button */}
        ...
        <div className="flex flex-col items-center justify-center h-[70vh] text-center">
          <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg max-w-md w-full">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-6">
              There are currently no questions available for this user. Please wait for the user to generate some.
            </p>
            <button
              onClick={() => window.history.back()}
              className="px-6 py-2 bg-lime-500 hover:bg-lime-600 text-white rounded-lg transition-colors"
            >
              Go Back
            </button>
          </div>
